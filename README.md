...
* _BTC wallet_ means you mine directly to your BTC wallet. In this case, yoyu can specify a username during the First Run Wizard, but it'll be ignored on this specific pool.
* _Site balance_ means you need to register on the pool's website beforehand. The payments will appear under your pool account, and you can specify the payout address on the site, not in RudeHash. In this case, yoyu can specify a BTC wallet address during the First Run Wizard, but it'll be ignored on this specific pool.
